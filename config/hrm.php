...
TXT,
    ...
    */
    'salary_submodules' => [
        ...
        'banks' => [
            'label'       => 'Salary Banks',
            'description' => 'Banks for employee salary transfer',
            'permission'  => 'hrm.salary.banks.view',
            'manage'      => 'hrm.salary.banks.manage',
            'route'       => 'admin.hrm.salary.banks.index',
            'status'      => 'active',
        ],
        'upload' => [
            'label'       => 'Upload Salary',
        ...
        'close' => [
            'label'       => 'Salary Close',
            'description' => 'Freeze period, disbursement, bank/cash export',
            'permission'  => 'hrm.salary.close.view',
            'manage'      => 'hrm.salary.close.manage',
            'route'       => 'admin.hrm.salary.close.index',
            'related_route_patterns' => ['admin.hrm.salary.disbursement.*'],
            'status'      => 'active',
        ],
        'bank-ledger' => [
            'label'       => 'Bank Ledger',
            'description' => 'Bank-wise payment register for closed payroll',
            'permission'  => 'hrm.salary.close.view',
            'manage'      => 'hrm.salary.close.manage',
            'route'       => 'admin.hrm.salary.bank-ledger.index',
            'status'      => 'active',
        ],
        'increment-rules' => [
    ...
    'salary_nav_groups' => [
        'Overview'         => ['dashboard'],
        'Salary Structure' => ['heads', 'grades', 'grade-details', 'banks', 'employee-salary'],
        'Payroll Run'      => ['upload', 'process', 'close', 'bank-ledger'],
    ...
    'modules' => [
        ...
        'hrm-shifts' => [
            ...
            'fields' => [
                ...
                'break_start_time'   => ['type' => 'time', 'label' => 'Lunch Start', 'help' => 'e.g. 13:00 for 1:00 PM'],
                'break_end_time'     => ['type' => 'time', 'label' => 'Lunch End', 'help' => 'e.g. 14:00 for 2:00 PM'],
                'is_night'       => ['type' => 'boolean', 'label' => 'Night Shift', 'default' => false],
                'description'    => ['type' => 'textarea', 'label' => 'Description'],
                'is_active'      => ['type' => 'boolean', 'label' => 'Active', 'default' => true],
            ],
            'columns' => ['code', 'name', 'factory_id', 'start_time', 'end_time', 'break_start_time', 'break_end_time', 'is_night', 'is_active'],
            'search'  => ['name', 'code'],
        ],
