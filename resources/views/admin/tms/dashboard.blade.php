...
@include('partials.erp.page-header', ['title' => 'Transport Dashboard', 'subtitle' => 'Pending requests, active trips, and OT summary'])
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
    ...
    <div class="erp-panel p-4"><p class="text-xs text-gray-500">OT Pending Payment</p><p class="text-2xl font-bold tabular-nums">{{ $otPending }}</p></div>
</div>
