...
<div><label class="erp-label">Bill No</label><input type="text" name="bill_no" class="erp-input" value="{{ $filters['bill_no'] ?? '' }}" placeholder="Search bill no…"></div>
...
<div><label class="erp-label">Workshop</label><input type="text" name="workshop" list="register-workshop-list" class="erp-input" value="{{ $filters['workshop'] ?? '' }}" placeholder="JK Motors"><datalist id="register-workshop-list">@foreach($workshops as $w)<option value="{{ $w }}">@endforeach</datalist></div>
<div><label class="erp-label">Item</label><input type="text" name="item" list="register-item-list" class="erp-input" value="{{ $filters['item'] ?? '' }}" placeholder="Spark Plug"><datalist id="register-item-list">@foreach($items as $i)<option value="{{ $i }}">@endforeach</datalist></div>
