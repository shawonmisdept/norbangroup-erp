...
@else
    ...
    @elseif($tab === 'maintenance' && $summary)
        @include('admin.tms.reports.partials.maintenance-summary')
    @elseif($tab === 'rental_charges' && $summary)
        @include('admin.tms.reports.partials.rental-charges-summary')
    @elseif($tab === 'ot' && $summary)
        @include('admin.tms.reports.partials.driver-pay-summary')
    @endif

    @unless($tab === 'fleet_cost')
