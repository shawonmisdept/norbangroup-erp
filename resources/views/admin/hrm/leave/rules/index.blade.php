...
<td class="text-right">@if(auth()->user()->canManageLeaveSubmodule('rules'))@include('partials.erp.table-actions', ['editUrl' => route('admin.hrm.leave.rules.edit', $rule)])@endif</td></tr>
