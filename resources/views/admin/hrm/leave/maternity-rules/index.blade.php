...
<td class="text-right">@if(auth()->user()->canManageLeaveSubmodule('maternity-rules'))@include('partials.erp.table-actions', ['editUrl' => route('admin.hrm.leave.maternity-rules.edit', $rule), 'destroyUrl' => route('admin.hrm.leave.maternity-rules.destroy', $rule), 'destroyConfirm' => 'Delete this maternity rule?'])@endif</td></tr>
