...
<div class="erp-panel max-w-lg"><div class="erp-panel-body"><form method="POST" action="{{ route('admin.hrm.leave.allocation.run') }}" class="space-y-3">@csrf
...
<button type="submit" class="erp-btn-primary" onclick="return confirm('Run allocation for all active employees?')">Run Allocation</button>
</form></div></div>@endif
@endsection
