...
<div id="careers-site-nav-panel" class="careers-header-nav-panel">
    ...
    <nav class="careers-nav careers-nav-local" aria-label="Portal shortcuts">
        ...
        <a href="{{ route('employee.team.index') }}" class="{{ request()->routeIs('employee.team.index') ? 'active' : '' }}">
            <svg class="careers-nav-icon" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 19l-7-7 7-7" stroke-linecap="round" stroke-linejoin="round"/></svg>
            Login
        </a>
    </nav>
</div>
