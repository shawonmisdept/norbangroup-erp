...
>
    <div class="emp-pwa-banner-inner">
        <div class="min-w-0 flex-1">
            <p class="emp-pwa-banner-title">Install Employee App</p>
            <p class="emp-pwa-banner-text">Add to home screen and get instant alerts even when the browser is closed.</p>
        </div>
