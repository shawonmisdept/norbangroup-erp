...
{
    /** @return list<string> */
    private function submodulePermissions(): array
    {
        $perms = ['hrm.attendance.approve'];

        foreach (config('hrm.attendance_submodules', []) as $sub) {
    ...
    {
        $extra = $this->submodulePermissions();
    ...
    {
        $remove = $this->submodulePermissions();
