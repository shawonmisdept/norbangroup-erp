...
class TmsTripCompletedNotification extends Notification
{
    ...
    public function toDatabase(object $notifiable): array
    {
        ...
        return [
            ...
            'message' => ($employee?->name ?? 'Employee') . '\'s trip on '
                . PortalDateTime::dateTime($this->request->pickup_at) . ' has been completed.',
