...
Route::prefix('admin')->name('admin.')->middleware(['auth'])->group(function () {
    ...
    Route::prefix('hrm')->name('hrm.')->middleware('factory.scope')->group(function () {
        ...
        Route::middleware('permission:hrm.recruitment.applications.manage')->group(function () {
            ...
            Route::get('/recruitment/applications/{application}/edit', [\App\Http\Controllers\Admin\Hrm\Recruitment\ApplicationController::class, 'edit'])->name('recruitment.applications.edit')->whereNumber('application');
            Route::put('/recruitment/applications/{application}', [\App\Http\Controllers\Admin\Hrm\Recruitment\ApplicationController::class, 'update'])->name('recruitment.applications.update')->whereNumber('application');
            Route::delete('/recruitment/applications/{application}', [\App\Http\Controllers\Admin\Hrm\Recruitment\ApplicationController::class, 'destroy'])->name('recruitment.applications.destroy')->whereNumber('application');
